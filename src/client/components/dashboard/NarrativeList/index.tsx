  ...
  render() {
    return (
      <>
        ...
        <Tabs defaultActiveKey="My narratives" id='narrative-tabs' onSelect={(e: string) => this.bootstrapHandleTabChange(e)}>
        ...
        <p>This is how tabs looks like straight out of bootstrap<br />
          This doesn't require extra javascript to switch from one tab to the other which is nice<br />
          Align anything on the tab like this New Narrative button must be forced. Not too bad tho. </p>
        <Button className="forcefully-move-button">New Narrative</Button>
        ...
        <Tab.Container defaultActiveKey="My narratives">
          <Nav>
            <Nav.Item bsPrefix='fooClass'> {/* this bsPrefix is dangerous  */}
