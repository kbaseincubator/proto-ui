  ...
  <>
    <ul className="list pa0 ml3" style={{ position: 'sticky', top: 0 }}>
      ...
      >
        <a
          data-hl-nav="profile"
          className="dib no-underline black-80 w-100 dim"
        >
          <span>Profile</span>
        </a>
      </li>
      <li
        data-hl-nav="account"
        className="mv1 hover-bg-light-gray br2 pointer pa2 flex justify-between"
        onClick={props.navOnClick}
      >
        <a
          data-hl-nav="account"
