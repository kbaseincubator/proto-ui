  ...
  render() {
    return (
      <div className="sign-in-container">
        ...
        <img
          style={{ marginTop: '1em' }}
          src="http://kbase.us/wp-content/uploads/2014/11/kbase-logo-web.png"
        />
          ...
          >
            <div className="sign-up-botton-spacer">
              <div className="sign-up-botton">
                {googleLogo}
                <div
                  className="input-radio google-input"
                  onClick={() => this.redirect('google-input')}
                >
                  <input
                    id="google-input"
                    type="radio"
            ...
            <div className="sign-up-botton-spacer">
              <div className="sign-up-botton">
                {orchidLogo}
                <div
                  className="input-radio orcid-input"
                  onClick={() => this.redirect('orcid-input')}
                >
                  <input
                    id="orcid-input"
                    type="radio"
            ...
            <div className="sign-up-botton-spacer">
              <div className="sign-up-botton">
                {globusLogo}
                <div
                  className="input-radio globus-input"
                  onClick={() => this.redirect('globus-input')}
                >
                  <input
                    id="globus-input"
                    type="radio"
